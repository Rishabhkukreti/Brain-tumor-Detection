...
class Gui:
    ...
    def __init__(self):
        ...
        WindowLabel.configure(background="grey", font=("Comic Sans MS", 16, "bold"))
        ...
        browseBtn = tkinter.Button(self.FirstFrame.getFrames(),background="lightsteelblue", text="Browse", width=8, command=self.browseWindow)
